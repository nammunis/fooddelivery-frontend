...
export default function Header() {
  return (
  <div className='h-[80px] w-full bg-white/20 backdrop-blur-lg border border-white/30 flex justify-center items-center gap-6 mb-5 shadow-2xl shadow-amber-500/5 rounded-xl relative'>
      ...
      <Link to='/cart' className="absolute right-4"><BiCart className="text-black text-3xl mr-8"/></Link>
  </div>
  )
}
